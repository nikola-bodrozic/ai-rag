...
# ==========================================
# 1. LIFESPAN (Moderni zamenski sistem za startup/shutdown)
# ==========================================
@asynccontextmanager
async def lifespan(app: FastAPI):
    # Sve što se izvršava PRI POKRETANJU aplikacije
    ...
    # Sve što se izvršava PRI GAŠENJU aplikacije
    print("🛑 Aplikacija se gasi...")

# Inicijalizacija FastAPI-ja sa lifespan menadžerom
app = FastAPI(
...
def initialize_rag_pipeline():
    """Inicijalizuje RAG pipeline pri startanju aplikacije"""
    ...
    if dokumenti:
        ...
        # Inicijalizacija modernog LLM-a sa ispravnim parametrom 'model'
...
Odgovor:"""
        ...
        # 🎯 FIX: Dodat je format_docs i pravilan LCEL lanac
        rag_chain = (
        ...
        print("✅ RAG pipeline je uspešno inicijalizovan!")
    else:
        print("⚠️ Nema dokumenata za indeksiranje! Ubaci .txt/.md fajlove u folder 'dokumentacija'.")
